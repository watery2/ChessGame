...
#pragma endregion
	...
	void ChangePawnsImage(System::Windows::Forms::PictureBox^ Pawn, int PawnBeingPromotedColor, int ChosenPromotion)
	{
		if (PawnBeingPromotedColor == 1)
		{
			...
			{
			case 0:
				Pawn->Image = System::Drawing::Image::FromFile("Chess_qlt60.png");
				break;
			case 1:
				Pawn->Image = System::Drawing::Image::FromFile("Chess_blt60.png");
				break;
			case 2:
				Pawn->Image = System::Drawing::Image::FromFile("Chess_nlt60.png");
				break;
			case 3:
				Pawn->Image = System::Drawing::Image::FromFile("Chess_rlt60.png");
				break;
			}
		}
		if (PawnBeingPromotedColor == 2)
		{
			...
			{
			case 0:
				Pawn->Image = System::Drawing::Image::FromFile("Chess_qdt60.png");
				break;
			case 1:
				Pawn->Image = System::Drawing::Image::FromFile("Chess_bdt60.png");
				break;
			case 2:
				Pawn->Image = System::Drawing::Image::FromFile("Chess_ndt60.png");
				break;
			case 3:
				Pawn->Image = System::Drawing::Image::FromFile("Chess_rdt60.png");
				break;
			}
		}
	}
